...
To know what version of odoo are you running pylint needs the parameter `pylint --load-plugins=pylint_odoo --valid_odoo_versions={YOUR_ODOO_VERSION}` with particular odoo version e.g. `"16.0"`
